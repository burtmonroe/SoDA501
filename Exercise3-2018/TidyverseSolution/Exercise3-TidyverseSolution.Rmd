---
title: "SoDA 501, Exercise 3 - `tidyverse' Solution"
output:
 html_notebook:
   code_folding: show
   highlight: tango
...
This document addresses one solution to the data-wrangling exercise described in [Exercise3.pdf](https://burtmonroe.github.io/SoDA501/Exercise3-2018/Exercise3.pdf). For the accompanying R Notebook with executable code, download the R Notebook from the pulldown menu on the upper right.  
